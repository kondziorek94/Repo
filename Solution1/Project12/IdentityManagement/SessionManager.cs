...
using Project10.IdentityManagement;
namespace Project10.Session
{
...
//zastap mechanim serialiacji binarnej poprzez serializacje do pliku w formacie XML albo JSON. (wyszukaj biblioteke ktora Ci to umożliwii)